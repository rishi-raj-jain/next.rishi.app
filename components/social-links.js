const SocialLinks = () => {
  return (
      <div className="mt-5 text-gray-400 flex flex-row space-x-5 items-center">
        ...
        <a rel="noopener noreferrer" href="https://rishi-raj-jain.medium.com" target="_blank">
        ...
        <a rel="noopener noreferrer" href="https://linkedin.com/in/rishi-raj-jain" target="_blank">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 16 16">
            <title>{`Rishi Raj Jain LinkedIn Profile Link`}</title>
            <path
              fill="currentColor"
